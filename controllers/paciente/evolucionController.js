...
const Evolucion = db.evoluciones;
...
module.exports = {
    ...
    list(req, res) {
        ...
        Evolucion.findAndCountAll({ where: condition,order:[[`${criterio}`,`${order}`]],limit,offset})
        .then(data => {
    ...
    getId (req, res) {
        ...
        Evolucion.findAndCountAll({ include: [
            {
                model: Expediente,
                require: true
            }
