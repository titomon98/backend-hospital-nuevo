...
module.exports = {
    ...
    listNoPay(req, res) {
        ...
        var condition = {estado:1, '$expedientes.solvencia$': 0, [Op.or]:[{'$expedientes.estado$': 0},{'$expedientes.estado$': 6},{'$expedientes.estado$': 7},{'$expedientes.estado$': 8},{'$expedientes.estado$': 9}]}
        console.log(busqueda)
        Cuenta.findAndCountAll({ 
            include: [
                {
