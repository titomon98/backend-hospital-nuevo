...
module.exports = {
    async get(req, res) {
        try {
          ...
          const getPagingData = (data, page, limit) => {
            ...
            return { totalItems, referido, totalPages, currentPage: page };
          };
    ...
    async create(req, res) {
        ...
        if (form.inventariado !== 'NO INVENTARIADO') {
            Comun.decrement(columnaExistencia, {
            ...
            try {
                const producto = await Comun.findByPk(form.id_medicamento)
